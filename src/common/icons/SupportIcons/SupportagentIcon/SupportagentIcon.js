...
const SvgComponent = ({ svgRef, title, ...props }) => (
    ...
    >
        <title>{title}</title>
        <path
            d="M264.6 300.4h-92C97 300.4 35.4 362 35.4 437.6h366.8c-.4-75.2-62-137.2-137.6-137.2zM235 237.6c7.2 0 14 2.4 19.2 6.8h33.2c16.4-17.2 26.4-40 26.4-65.6 0-52.8-42.8-95.2-95.2-95.2s-95.2 42.4-95.2 95.2c0 35.6 19.6 66.8 48.8 83.2 3.2-14 15.6-24.4 30-24.4H235z"
...
const SupportagentIcon = React.forwardRef((props, ref) => (
